...
def create_connections(points):
    # generate the connections between a inputed list of points
    pass


def find_shapes(points):
    # make it so that it can take all points as input and output a list of shapes made up of inputed points
    pass


def draw_connections(
    point: list, point_connections: list, draw: ImageDraw.ImageDraw, width: int
):
    for i in point_connections:
